      ...
      <nav className='sec-nav'>
        ...
        <div className="navbar">
          <ul className="nav-links">
            ...
            <Link to='about' className='link' smooth={true} offset={-80}>About</Link>
            <Link to='skill' className='link' smooth={true} offset={-80} >Skills</Link>
        ...
        <div className="mobile"  style={{display:showMenu?'flex':'none'}}>
          ...
          <Link to='about'  smooth={true} offset={-80} onClick={()=>setShowMenu(false)}>About</Link>
